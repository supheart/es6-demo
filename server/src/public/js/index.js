...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	    ...
	    var tt = new _timer2.default();
	    tt.countDown(1497785780000, function (result) {
	        console.log(result);
	    }, function () {
	    ...
	    _createClass(Timer, [{
	        ...
	        value: function countDown(end, update, handle) {
	            ...
	            if (now - end > 0) {
	                ...
	                var pxDay = 24 * 60 * 60 * 1000;
	                var pxHour = 60 * 60 * 1000;
	                var pxMinute = 60 * 1000;
	                var pxSecond = 1000;
	                var days = Math.floor(lastTime / pxDay);
	                var hours = Math.floor((lastTime - pxDay * days) / pxHour);
	                var minutes = Math.floor((lastTime - pxDay * days - pxHour * hours) / pxMinute);
	                var seconds = Math.floor((lastTime - pxDay * days - pxHour * hours - pxMinute * minutes) / pxSecond);
	                var result = [];
	                if (days > 0) {
